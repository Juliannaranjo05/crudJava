...
public class user {
    ...
    @Column(name="fecha_registro",length = 150,nullable = false)
    private String fecha_registro;

    //constructor
    public user (int id_usuario,String nombre ,String email, String contrasena, int telefono, String fecha_registro ){
    ...
    public String get_fecha_registro() {
      return fecha_registro;
    }
    
    //set del phone 
    public void set_fecha_registro(String fecha_registro){
       this.fecha_registro = fecha_registro;
   }
}